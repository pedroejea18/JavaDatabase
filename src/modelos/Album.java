...
public class Album {
	...
	//constructor para pedro 
	public String toString2() {
		String cadena = "";
		cadena = cadena + "Album [codigo= " + codigo + ", autor= " + autor;
		if (autor.equalsIgnoreCase("banda")) {
			cadena = cadena + ", Codigo banda " + banda.getCodigo();
		}
		else {
			cadena = cadena + ", Codigo musico " + musico.getCodigo();
	...
	//constructor para cancion
	public Album(int codigo) {
		this.codigo = codigo;
	}
